 ...
 */
class Testimonial_FlatCatalogSearch_Block_Advanced_Form extends Mage_Core_Block_Template
{
    public function _prepareLayout()
    {
        ...
        if ($breadcrumbs = $this->getLayout()->getBlock('breadcrumbs')) {
            $breadcrumbs->addCrumb('home', array(
                'label'=>Mage::helper('flatcatalogsearch')->__('Home'),
                'title'=>Mage::helper('flatcatalogsearch')->__('Go to Home Page'),
                'link'=>Mage::getBaseUrl()
            ))->addCrumb('search', array(
                'label'=>Mage::helper('flatcatalogsearch')->__('Catalog Advanced Search')
            ));
        }
    ...
    public function getAttributeSelectElement($attribute)
    {
        ...
        if (is_array($options) && count($options)>2) {
            ...
            array_unshift($options, array('value'=>'', 'label'=>Mage::helper('flatcatalogsearch')->__('All')));
        }
    ...
    {
        $options = array(
            array('value' => '',  'label' => Mage::helper('flatcatalogsearch')->__('All')),
            array('value' => '1', 'label' => Mage::helper('flatcatalogsearch')->__('Yes')),
            array('value' => '0', 'label' => Mage::helper('flatcatalogsearch')->__('No'))
        );
    ...
    {
        return Mage::getSingleton('flatcatalogsearch/advanced');
    }
