<?php
class Testimonial_MageDoc_Block_Adminhtml_Genericarticle extends Mage_Adminhtml_Block_Widget_Grid_Container
{
    public function __construct()
    {
        $this->_controller = 'adminhtml_genericArticle';
        $this->_blockGroup = 'magedoc';
        $this->_headerText = Mage::helper('magedoc')->__('Manage Generic Articles');
        parent::__construct();
    ...
    {
        return $this->getRequest()->getActionName() == Testimonial_MageDoc_Block_Adminhtml_GenericArticle_Grid::SUGGEST_ACTION_NAME;
    }
}