...
class Testimonial_MageDoc_Block_Adminhtml_Product_Map extends Mage_Adminhtml_Block_Widget_Grid_Container
{
    public function __construct()
    {
        $this->_controller = 'adminhtml_product_map';
        $this->_blockGroup = 'magedoc';
        $this->_headerText = Mage::helper('magedoc')->__('Manage Products Map');
        parent::__construct();
    ...
    protected function _prepareLayout()
    {
        ...
        /**
         * @var $grid Testimonial_MageDoc_Block_Adminhtml_Product_Map_Grid
         */
        $grid = $this->getChild('grid');

        if ($grid->getCurrentDirectory()->canSuggestProducts()){
