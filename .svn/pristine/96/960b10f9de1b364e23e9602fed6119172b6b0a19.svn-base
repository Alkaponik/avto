 ...
 *
 * @method Testimonial_FlatCatalogSearch_Model_Resource_Query _getResource()
 * @method Testimonial_FlatCatalogSearch_Model_Resource_Query getResource()
 * @method string getQueryText()
 * @method Testimonial_FlatCatalogSearch_Model_Query setQueryText(string $value)
 * @method int getNumResults()
 * @method Testimonial_FlatCatalogSearch_Model_Query setNumResults(int $value)
 * @method int getPopularity()
 * @method Testimonial_FlatCatalogSearch_Model_Query setPopularity(int $value)
 * @method string getRedirect()
 * @method Testimonial_FlatCatalogSearch_Model_Query setRedirect(string $value)
 * @method string getSynonymFor()
 * @method Testimonial_FlatCatalogSearch_Model_Query setSynonymFor(string $value)
 * @method int getDisplayInTerms()
 * @method Testimonial_FlatCatalogSearch_Model_Query setDisplayInTerms(int $value)
 * @method int getIsActive()
 * @method Testimonial_FlatCatalogSearch_Model_Query setIsActive(int $value)
 * @method int getIsProcessed()
 * @method Testimonial_FlatCatalogSearch_Model_Query setIsProcessed(int $value)
 * @method string getUpdatedAt()
 * @method Testimonial_FlatCatalogSearch_Model_Query setUpdatedAt(string $value)
 *
 * @category    Mage
 * @package     Testimonial_FlatCatalogSearch
 * @author      Magento Core Team <core@magentocommerce.com>
 */
class Testimonial_FlatCatalogSearch_Model_Query extends Mage_Core_Model_Abstract
{
    /**
     * Event prefix
     *
     * @var string
     */
    protected $_eventPrefix = 'flatcatalogsearch_query';
     ...
     * @var string
     */
    protected $_eventObject = 'flatcatalogsearch_query';
    ...
    {
        $this->_init('flatcatalogsearch/query');
    }

    /**
     * Retrieve search collection
     *
     * @return Testimonial_FlatCatalogSearch_Model_Resource_Search_Collection
     */
    public function getSearchCollection()
    {
        return Mage::getResourceModel('flatcatalogsearch/search_collection');
    }
    ...
    public function getSuggestCollection()
    {
        ...
        if (is_null($collection)) {
            $collection = Mage::getResourceModel('flatcatalogsearch/query_collection')
