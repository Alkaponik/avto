 ...
 *
 * @method Testimonial_FlatCatalogSearch_Model_Resource_Fulltext _getResource()
 * @method Testimonial_FlatCatalogSearch_Model_Resource_Fulltext getResource()
 * @method int getProductId()
 * @method Testimonial_FlatCatalogSearch_Model_Fulltext setProductId(int $value)
 * @method int getStoreId()
 * @method Testimonial_FlatCatalogSearch_Model_Fulltext setStoreId(int $value)
 * @method string getDataIndex()
 * @method Testimonial_FlatCatalogSearch_Model_Fulltext setDataIndex(string $value)
 *
 * @category    Mage
 * @package     Testimonial_FlatCatalogSearch
 * @author      Magento Core Team <core@magentocommerce.com>
 */
class Testimonial_FlatCatalogSearch_Model_Fulltext extends Mage_Core_Model_Abstract
{
    ...
    {
        $this->_init('flatcatalogsearch/fulltext');
    }
    ...
    {
        Mage::dispatchEvent('flatcatalogsearch_index_process_start', array(
            'store_id'      => $storeId,
        ...
        Mage::dispatchEvent('flatcatalogsearch_index_process_complete', array());
     ...
     *
     * @param Testimonial_FlatCatalogSearch_Model_Query $query
     * @return Testimonial_FlatCatalogSearch_Model_Fulltext
     */
    public function prepareResult($query = null)
    {
        if (!$query instanceof Testimonial_FlatCatalogSearch_Model_Query) {
            $query = Mage::helper('flatcatalogsearch')->getQuery();
        }
        $queryText = Mage::helper('flatcatalogsearch')->getQueryText();
