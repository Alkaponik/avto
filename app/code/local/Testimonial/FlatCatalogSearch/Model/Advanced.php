 ...
 *
 * @method Testimonial_FlatCatalogSearch_Model_Resource_Advanced _getResource()
 * @method Testimonial_FlatCatalogSearch_Model_Resource_Advanced getResource()
 * @method int getEntityTypeId()
 * @method Testimonial_FlatCatalogSearch_Model_Advanced setEntityTypeId(int $value)
 * @method int getAttributeSetId()
 * @method Testimonial_FlatCatalogSearch_Model_Advanced setAttributeSetId(int $value)
 * @method string getTypeId()
 * @method Testimonial_FlatCatalogSearch_Model_Advanced setTypeId(string $value)
 * @method string getSku()
 * @method Testimonial_FlatCatalogSearch_Model_Advanced setSku(string $value)
 * @method int getHasOptions()
 * @method Testimonial_FlatCatalogSearch_Model_Advanced setHasOptions(int $value)
 * @method int getRequiredOptions()
 * @method Testimonial_FlatCatalogSearch_Model_Advanced setRequiredOptions(int $value)
 * @method string getCreatedAt()
 * @method Testimonial_FlatCatalogSearch_Model_Advanced setCreatedAt(string $value)
 * @method string getUpdatedAt()
 * @method Testimonial_FlatCatalogSearch_Model_Advanced setUpdatedAt(string $value)
 *
 * @category    Mage
 * @package     Testimonial_FlatCatalogSearch
 * @author      Magento Core Team <core@magentocommerce.com>
 */
class Testimonial_FlatCatalogSearch_Model_Advanced extends Mage_Core_Model_Abstract
{
    /**
     ...
     *
     * @var object | Testimonial_FlatCatalogSearch_Model_Resource_Fulltext_Engine
     */
    ...
    {
        $this->_getEngine();
        $this->_init('flatcatalogsearch/advanced');
    }
     ...
     *
     * @return Testimonial_FlatCatalogSearch_Model_Resource_Advanced
     */
     ...
     *
     * @deprecated after 1.4.1.0 - use Testimonial_FlatCatalogSearch_Model_Resource_Advanced->_prepareCondition()
     *
     ...
     *
     * @param   array $values
     * @return  Testimonial_FlatCatalogSearch_Model_Advanced
     */
    public function addFilters($values)
    {
        ...
        if ($allConditions) {
            ...
            Mage::throwException(Mage::helper('flatcatalogsearch')->__('Please specify at least one search term.'));
        }
    ...
    protected function _addSearchCriteria($attribute, $value)
    {
            ...
            if (isset($value['from']) && isset($value['to'])) {
                if (!empty($value['from']) || !empty($value['to'])) {
                    ...
                    if (strlen($value['from']) > 0 && strlen($value['to']) > 0) {
                        ...
                        // and more
                        $value = Mage::helper('flatcatalogsearch')->__('%s and greater', ($currencyModel ? $from : $value['from']));
                    } elseif (strlen($value['to']) > 0) {
                        // to
                        $value = Mage::helper('flatcatalogsearch')->__('up to %s', ($currencyModel ? $to : $value['to']));
                    }
                } else {
                    return $this;
                }
        ...
        if (($attribute->getFrontendInput() == 'select' || $attribute->getFrontendInput() == 'multiselect')
            ...
            $value = $value == 1
                ? Mage::helper('flatcatalogsearch')->__('Yes')
                : Mage::helper('flatcatalogsearch')->__('No');
        }
     ...
     *
     * @return Testimonial_FlatCatalogSearch_Model_Resource_Advanced_Collection
     */
     ...
     *
     * @param Testimonial_FlatCatalogSearch_Model_Resource_Advanced_Collection $collection
