 ...
 */
class Testimonial_FlatCatalogSearch_Model_Fulltext_Observer
{
    /**
     ...
     * @return Testimonial_FlatCatalogSearch_Model_Fulltext_Observer
     */
    ...
    public function eavAttributeChange(Varien_Event_Observer $observer)
    {
        ...
        if ($showNotice) {
            ...
            Mage::getSingleton('adminhtml/session')->addNotice(
                Mage::helper('flatcatalogsearch')->__('Attribute setting change related with Search Index. Please run <a href="%s">Rebuild Search Index</a> process.', $url)
            );
        }
