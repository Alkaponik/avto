 ...
 */
class Testimonial_FlatCatalogSearch_Model_Resource_Advanced_Collection extends Mage_Catalog_Model_Resource_Product_Collection
{
    /**
                ...
                foreach ($conditions as $attributeId => $conditionValue) {
                    ...
                    if (is_array($conditionValue)) {
                        ...
                        elseif (isset($conditionValue['from']) && isset($conditionValue['to'])) {
                            $invalidDateMessage = Mage::helper('flatcatalogsearch')->__('Specified date is invalid.');
