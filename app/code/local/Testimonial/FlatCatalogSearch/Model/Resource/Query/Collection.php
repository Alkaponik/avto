 ...
 */
class Testimonial_FlatCatalogSearch_Model_Resource_Query_Collection extends Mage_Core_Model_Resource_Db_Collection_Abstract
{
    /**
     * Store for filter
     *
    ...
    public function setQueryFilter($query)
    {
        ...
        $this->getSelect()->reset(Zend_Db_Select::FROM)->distinct(true)
            ->from(
                array('main_table' => $this->getTable('flatcatalogsearch/search_query')),
