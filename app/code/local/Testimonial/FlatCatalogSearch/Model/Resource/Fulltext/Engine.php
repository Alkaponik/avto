 ...
 */
class Testimonial_FlatCatalogSearch_Model_Resource_Fulltext_Engine extends Mage_Core_Model_Resource_Db_Abstract
{
    /**
     * Init resource model
     *
     ...
     * @return Testimonial_FlatCatalogSearch_Model_Resource_Fulltext_Engine
     */
    ...
    public function saveEntityIndexes($storeId, $entityIndexes, $entity = 'product')
    {
        ...
        if ($data) {
            Mage::getResourceHelper('flatcatalogsearch')
    ...
    {
        return Mage::helper('flatcatalogsearch')->prepareIndexdata($index, $separator);
    }
    ...
    {
        return Mage::getResourceModel('flatcatalogsearch/fulltext_collection');
    }
    ...
    {
        return Mage::getResourceModel('flatcatalogsearch/advanced_collection');
    }
