 ...
 */
class Testimonial_FlatCatalogSearch_Model_Resource_Query extends Mage_Core_Model_Resource_Db_Abstract
{
    /**
     * Init resource data
     *
    ...
    {
        $this->_init('flatcatalogsearch/search_query', 'query_id');
    }
     ...
     * @param string $value
     * @return Testimonial_FlatCatalogSearch_Model_Resource_Query
     */
