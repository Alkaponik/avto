...
class Testimonial_MageDoc_Model_Mysql4_Retailer_Data_Import_Adapter_Config_Collection extends Mage_Core_Model_Mysql4_Collection_Abstract
{
    ...
    {
        return $this->_toOptionArray( 'config_id' );
    }
