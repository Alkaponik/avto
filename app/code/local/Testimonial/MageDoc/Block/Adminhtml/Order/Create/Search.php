...
class Testimonial_MageDoc_Block_Adminhtml_Order_Create_Search extends Mage_Adminhtml_Block_Sales_Order_Create_Search
{

    public function __construct()
    {
        parent::__construct();
        $this->setId('magedoc_adminhtml_order_create_search');
    }
