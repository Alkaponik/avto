 ...
 */
class Testimonial_MageDoc_Block_Adminhtml_Category_Widget_Chooser extends Testimonial_MageDoc_Block_Adminhtml_Category_Tree
{
    ...
    {
        parent::__construct();
        $this->setTemplate('magedoc/category/widget/tree.phtml');
    ...
    public function prepareElementHtml(Varien_Data_Form_Element_Abstract $element)
    {
        ...
        $chooser = $this->getLayout()->createBlock('magedoc/adminhtml_category_widget_chooser')
            ->setElement($element)
