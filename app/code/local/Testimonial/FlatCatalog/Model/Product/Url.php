...
class Testimonial_FlatCatalog_Model_Product_Url extends Varien_Object
{
     ...
     *
     * @param Testimonial_FlatCatalog_Model_Product $product
     * @param array $params the URL route params
     * @return string
     */
    public function getUrlInStore(Testimonial_FlatCatalog_Model_Product $product, $params = array())
    {
     ...
     * @return string
     */
    public function getUrl(Testimonial_FlatCatalog_Model_Product $product, $params = array())
    {
        $routePath      = '';
        $routeParams    = $params;
        ...
        } else if (Mage::helper('flatcatalog')->isUrlRewritesEnabled()) {
            $requestPath = $product->getRequestPath();
            if (empty($requestPath) && $requestPath !== false) {
                $idPath = sprintf('rxproduct/%d', $product->getEntityId());
                if ($categoryId) {
        ...
        if (!empty($requestPath)) {
            ...
            $routePath = 'flatcatalog/product/view';
